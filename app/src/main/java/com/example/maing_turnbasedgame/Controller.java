...
public class Controller {
    int turnNumber = 1; int random, store;
    Random randomizer = new Random();
    public Controller(){}

    public void Turn(TextView announce, TextView damage, ImageView juvskill,ImageView btnnext, JUV mc, GRF gray){
    ...
    public void skill(TextView announce, TextView damage, ImageView juvskill, ImageView btnnext, JUV mc, GRF gray) {
        if (mc.getMana() < 10) {
            hideskill(juvskill);
    ...
    public void reset(TextView announce, TextView damage, ImageView juvskill, ImageView btnnext, JUV mc, GRF gray) {
        showskill(juvskill);
        showbutton(btnnext);
        announce.setText("It's   Juvia   Lockser's   turn");
        mc.reset();
